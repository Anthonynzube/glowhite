                    ...
                    <div class="row">
                        <div class="col-lg-4 col-md-6 col-sm-6 col-12">
                            <div class="product-wrap mb-50">
                                ...
                                <div class="product-content-1 title-font-width-400 text-center">
                                    <h3 class="pad-tb product-title-gold">Pure Carrot<br>Kojic Balance Lotion</h3>
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-6 col-12">
                            <div class="product-wrap mb-50">
                                ...
                                <div class="product-content-1 title-font-width-400 text-center">
                                    <h3 class="pad-tb product-title-gold">Pure Carrot<br>Bio Balance Lotion</h3>
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-6 col-12">
                            <div class="product-wrap mb-50">
                                ...
                                <div class="product-content-1 title-font-width-400 text-center">
                                    <h3 class="pad-tb product-title-gold">Pure Carrot<br>Gold Lotion</h3>
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-6 col-12">
                            <div class="product-wrap mb-50">
                                ...
                                <div class="product-content-1 title-font-width-400 text-center">
                                    <h3 class="pad-tb product-title-gold">Pure Carrot<br>Flawless Lotion</h3>
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-6 col-12">
                            <div class="product-wrap mb-50">
                                ...
                                <div class="product-content-1 title-font-width-400 text-center">
                                    <h3 class="pad-tb product-title-gold">Q White<br>Carotte Lotion</h3>
                                    <p>This hydrating moisturizer gives<br>
                                        the skin a luminous look with...</p>
                                    <div class="slider-btn-2 pad-tb" id="slider-btn-gold">
                                        <a class="animated" href="product-details.html">Quick View </a>
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-6 col-12">
                            <div class="product-wrap mb-50">
                                ...
                                <div class="product-content-1 title-font-width-400 text-center">
                                    <h3 class="pad-tb product-title-gold">Q White<br>Maxi-Tone Lotion</h3>
                                    <p>A Skin Illuminating Moisturizer.<br>
                                        Its creamy texture...</p>
                                    <div class="slider-btn-2 pad-tb" id="slider-btn-gold">
                                        <a class="animated" href="product-details.html">Quick View </a>
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-6 col-12">
                            <div class="product-wrap mb-50">
                                ...
                                <div class="product-content-1 title-font-width-400 text-center">
                                    <h3 class="pad-tb product-title-gold">Q White <br>Moringa Claire Lotion</h3>
                                    <p>Designed to penetrate the <br>
                                        5 layers of the skin...</p>
                                    <div class="slider-btn-2 pad-tb" id="slider-btn-gold">
                                        <a class="animated" href="product-details.html">Quick View </a>
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-6 col-12">
                            <div class="product-wrap mb-50">
                                ...
                                <div class="product-content-1 title-font-width-400 text-center">
                                    <h3 class="pad-tb product-title-gold">Q White <br>Gold Lotion</h3>
                                    <p>This hydrating moisturizer gives <br>
                                        the skin a luminous look with...</p>
                                    <div class="slider-btn-2 pad-tb" id="slider-btn-gold">
                                        <a class="animated" href="product-details.html">Quick View </a>
